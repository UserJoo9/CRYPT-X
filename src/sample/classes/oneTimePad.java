    ...
    void Enc(ActionEvent event) {
        ...
        if (!fileCheckBox.isSelected()) {
            ...
            if( keyField.getText().isEmpty()) {
                ...
                status1.setText("");
                status2.setText("");
            }else if(keyField.getText().length() < textAreaClean.getText().length()){
                status.setText("the key is too short !");
                status1.setText("");
                status2.setText("");
            }else if(keyField.getText().length() > textAreaClean.getText().length()){
                status.setText("the key is too long !");
                status1.setText("");
                status2.setText("");
...
///////////////////////////////////// file select ///////////////////////////////////////////////////////////////////////////////////
            if (keyField.getText().isEmpty()) {
                ...
                status1.setText("");
                status2.setText("");
//                String src = textAreaClean.getText();
//                String dest = textAreaED.getText();
